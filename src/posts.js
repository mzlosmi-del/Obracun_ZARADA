...
**Ukratko:** godišnji porez plaćaju fizička lica čiji **neto dohodak** (posle plaćenih poreza i doprinosa) u kalendarskoj godini pređe **tri prosečne godišnje zarade** — za 2025. godinu to je **5.439.096 RSD** (u proseku oko 453.000 RSD neto mesečno). Stopa je **10%** na oporezivi dohodak do 10.878.192 RSD, a **15%** na deo preko toga. Prijava PP GPDG podnosi se elektronski do **15. maja** naredne godine — za dohodak iz 2025. rok je bio 15. maj 2026, a za dohodak iz 2026. biće 15. maj 2027.

> **Napomena:** Tekst je informativnog karaktera i ne zamenjuje poreski ili pravni savet. Pri izmeni propisa tekst se hitno usklađuje.

## Ključne činjenice (za dohodak ostvaren u 2025)

- **Neoporezivi cenzus:** 5.439.096 RSD neto godišnje = 3 × prosečna godišnja zarada za 2025. (1.813.032 RSD, RZS).
- **Stope:** 10% na oporezivi dohodak do **10.878.192 RSD** (6 prosečnih godišnjih zarada); 15% samo na deo preko toga.
- **Olakšica za mlađe od 40 godina:** dodatno umanjenje od **5.439.096 RSD** na zbir zarada, prihoda od samostalne delatnosti i autorskih prihoda.
- **Lični odbici:** 725.213 RSD za obveznika + 271.955 RSD po izdržavanom članu porodice (najviše 50% dohotka za oporezivanje).
- **Prijava:** obrazac **PP GPDG**, isključivo elektronski preko portala ePorezi, **samooporezivanjem** — Poreska uprava od 1. aprila postavlja unapred popunjenu prijavu koju obveznik proverava i podnosi.
- **Rok:** 15. maj godine koja sledi godini za koju se porez utvrđuje (podnošenje **i** plaćanje).

## Ko je obveznik godišnjeg poreza

Obveznik je fizičko lice čiji dohodak u kalendarskoj godini pređe cenzus od tri prosečne godišnje zarade po zaposlenom isplaćene u Srbiji u toj istoj godini (podatak RZS). Pri tome:
...
U godišnji dohodak ulaze (čl. 87 ZPDG): zarada (uključujući [bonuse i nagrade](/blog/porez-na-bonus)), oporezivi prihod od samostalne delatnosti (preduzetnici koji vode knjige, paušalci, lična zarada), oporezivi prihodi od autorskih i srodnih prava i prava industrijske svojine, prihodi od nepokretnosti (zakup), od davanja u zakup pokretnih stvari, prihodi sportista i sportskih stručnjaka, od ugostiteljskih usluga, prihodi pomoraca, ostali oporezivi „drugi prihodi", kao i svi ti prihodi ostvareni i oporezovani u drugoj državi (za rezidente — umanjeni za porez plaćen u inostranstvu).

**Ne ulaze:** dividende, kamate i drugi prihodi od kapitala, kao ni kapitalni dobici (prodaja nekretnina, akcija, kriptovaluta) — oni se oporezuju posebnim, konačnim porezima i ne sabiraju se u godišnji dohodak.

Postoji i detalj koji gotovo svi vodiči preskaču: ako vam je u toku godine izvršen **povraćaj više plaćenih doprinosa** (jer su doprinosi plaćeni preko najviše godišnje osnovice, koja za 2025. iznosi 7.877.100 RSD), taj povraćaj se **dodaje** dohotku koji se oporezuje godišnjim porezom. Kako funkcionišu stope i osnovice doprinosa, objašnjava [vodič o doprinosima](/blog/doprinosi-srbija).

## Kako se obračunava — formula u 4 koraka

1. **Saberite neto prihode** iz svih izvora koji ulaze u dohodak (prihodi umanjeni za plaćene poreze i doprinose), plus eventualni povraćaj doprinosa.
2. **Mlađi od 40 godina** (na dan 31. decembra godine za koju se porez utvrđuje): zbir zarada, prihoda od samostalne delatnosti i autorskih prihoda dodatno umanjite za **5.439.096 RSD** (najviše do visine tog zbira).
3. Od rezultata oduzmite **neoporezivi cenzus** 5.439.096 RSD → to je *dohodak za oporezivanje*. Ako je nula ili manje, niste obveznik i prijava se ne podnosi.
4. Oduzmite **lične odbitke** (725.213 RSD za sebe + 271.955 RSD po izdržavanom članu, ukupno najviše 50% dohotka za oporezivanje) → to je poreska osnovica. Na osnovicu do 10.878.192 RSD porez je **10%**, na deo preko **15%**.

| Neto dohodak u 2025. | Obveznik stariji od 40 | Obveznik mlađi od 40* |
|---|---|---|
| do 5.439.096 RSD | nije obveznik | nije obveznik |
| 5.439.097 – 10.878.192 RSD | plaća porez | nije obveznik |
| preko 10.878.192 RSD | plaća porez | plaća porez |

\\* važi kada se dohodak sastoji od zarada, samostalne delatnosti i/ili autorskih prihoda — na druge vrste prihoda (npr. zakup) dodatno umanjenje se ne primenjuje.

## Primeri obračuna u dinarima

**Primer 1 — direktor (45 god.), neto zarada 7.000.000 RSD godišnje (≈ 583.000 mesečno), bez izdržavanih članova:**

- Dohodak za oporezivanje: 7.000.000 − 5.439.096 = **1.560.904 RSD**
- Lični odbitak: 725.213 RSD (manje od 50% dohotka, priznaje se ceo)
- Poreska osnovica: 1.560.904 − 725.213 = 835.691 RSD
- Godišnji porez: 835.691 × 10% = **83.569 RSD** — efektivno svega ≈ 1,2% ukupnog dohotka.

Isti obveznik sa **dva izdržavana člana** porodice: odbici bi bili 725.213 + 2 × 271.955 = 1.269.123 RSD, ali se priznaju najviše do 50% dohotka za oporezivanje (780.452 RSD), pa je porez 780.452 × 10% = **78.045 RSD**.

**Primer 2 — programer (32 god.), neto zarada 9.000.000 RSD godišnje (750.000 mesečno):**

- Dodatno umanjenje za mlađe od 40: 9.000.000 − 5.439.096 = 3.560.904 RSD
- Minus cenzus: 3.560.904 − 5.439.096 < 0 → dohodak za oporezivanje je **0**
- **Ne podnosi prijavu i ne plaća ništa.** Zahvaljujući olakšici, za mlađe od 40 godina koji žive od zarade prag je efektivno 10.878.192 RSD neto (≈ 906.000 mesečno).

**Primer 3 — obveznik (50 god.), neto dohodak 20.000.000 RSD, bez izdržavanih članova:**

- Dohodak za oporezivanje: 20.000.000 − 5.439.096 = 14.560.904 RSD
- Osnovica: 14.560.904 − 725.213 = 13.835.691 RSD
- Porez: 10.878.192 × 10% + 2.957.499 × 15% = 1.087.819 + 443.625 = **1.531.444 RSD**

Za brzu procenu svoje obaveze koristite naš [kalkulator godišnjeg poreza](/godisnji-porez).

## Prijava PP GPDG — korak po korak

Od poreza za 2022. godinu godišnji porez se utvrđuje **samooporezivanjem** — Poreska uprava više ne donosi rešenje, već obveznik sam podnosi prijavu i plaća porez. Procedura:

1. **Do 1. aprila** Poreska uprava na portalu [ePorezi](https://www.purs.gov.rs/e-porezi/portal.html) postavlja **unapred popunjenu prijavu** PP GPDG (status „u pripremi") za sve koji su po službenim evidencijama prešli cenzus.
2. Prijavite se na ePorezi (kvalifikovani elektronski sertifikat, eID/ConsentID nalog ili SmartBox aplikacija) i **proverite podatke**. Najčešća ispravka: broj izdržavanih članova porodice — polje 3.13.2 se **ne popunjava automatski**, odbitke za članove morate sami uneti.
3. Kliknite **„Potpiši i podnesi"** — obavezno i kada nemate nijednu izmenu. Postavljena radna verzija se ne računa kao podneta prijava.
4. Po proknjižavanju prijave dobijate nalog za plaćanje sa QR kodom. Porez se plaća **najkasnije do 15. maja**, istog dana kada ističe i rok za prijavu.

Ako vam Poreska uprava nije postavila unapred popunjenu prijavu (npr. prihod je prijavljen po broju pasoša ili podaci nedostaju), obavezni ste da prijavu sami popunite i podnesete u istom roku. Nerezidenti prijavu podnose preko poreskog punomoćnika.

## Šta ako propustite rok

Za dohodak iz 2025. rok je istekao **15. maja 2026**. Ako prijavu niste podneli: Poreska uprava će je podneti umesto vas na osnovu podataka kojima raspolaže, obaveza se uvećava za **kamatu**, a protiv obveznika se podnosi zahtev za pokretanje **prekršajnog postupka** (čl. 180 Zakona o poreskom postupku i poreskoj administraciji). Rešenje je podneti prijavu i platiti porez što pre — kamata teče od dana dospelosti. Grešku u već podnetoj prijavi ispravljate izmenjenom prijavom (čl. 40 ZPPPA).

## Najčešće greške (i zastarele informacije po internetu)

- **„Čekam rešenje Poreske uprave."** Zastarelo — rešenja ne postoje od poreza za 2022. godinu. Porez se utvrđuje samooporezivanjem i niko vas neće „obavestiti" o obavezi; stariji tekstovi po internetu i dalje opisuju ukinuti sistem.
- **Poređenje bruto prihoda sa cenzusom.** Cenzus se poredi sa dohotkom *posle* plaćenih poreza i doprinosa. Neko sa bruto zaradom od 7.000.000 RSD godišnje imao je u 2025. neto oko 4.940.000 RSD — ispod cenzusa, dakle nije obveznik.
- **„Prijava je popunjena, dakle podneta je."** Nije — unapred popunjena prijava je radna verzija. Bez klika na „Potpiši i podnesi" smatra se da prijavu niste podneli.
- **Uračunavanje dividendi i kapitalnih dobitaka.** Ne ulaze u godišnji porez — oporezuju se posebno i konačno.
- **Zaboravljeni odbici za izdržavane članove.** Unose se ručno u prijavu; ako ih ne upišete, platićete više nego što morate. Odbitak za isto izdržavano lice može koristiti samo jedan obveznik.

Frilenseri i preduzetnici: u godišnji dohodak ulazi i oporezivi prihod od samostalne delatnosti, pa se visokim zaradama iz [frilensa](/blog/porez-za-frilensere) cenzus može preći — mesečni [neoporezivi iznos zarade od 34.221 RSD](/neoporezivi-iznos-2026) je zasebna kategorija i nema veze sa godišnjim cenzusom.

## Izvori

- [Poreska uprava — Godišnji porez na dohodak građana (Poreski informator, april 2026)](https://www.purs.gov.rs/upload/media/2026/4/1/760671/%D0%93%D0%BE%D0%B4%D0%B8%D1%88%D1%9A%D0%B8_%D0%BF%D0%BE%D1%80%D0%B5%D0%B7_%D0%BD%D0%B0_%D0%B4%D0%BE%D1%85%D0%BE%D0%B4%D0%B0%D0%BA_%D0%B3%D1%80%D0%B0%D1%92%D0%B0%D0%BD%D0%B0.pdf)
- [Zakon o porezu na dohodak građana](https://www.paragraf.rs/propisi/zakon_o_porezu_na_dohodak_gradjana.html) — čl. 87–89 (obveznik, dohodak, olakšice, stope)
- Objašnjenje Ministarstva finansija u vezi sa godišnjim porezom za 2025. godinu, br. 1023186 od 30. marta 2026.
- RZS — prosečna godišnja zarada po zaposlenom za 2025: 1.813.032 RSD
`,
    faq: [
      { q: "Ko plaća godišnji porez na dohodak građana?", a: "Fizička lica čiji neto dohodak (posle plaćenih poreza i doprinosa) u kalendarskoj godini pređe tri prosečne godišnje zarade u Srbiji — za 2025. godinu 5.439.096 RSD. Rezidenti prijavljuju svetski dohodak, nerezidenti samo dohodak ostvaren u Srbiji." },
      { q: "Koliki je neoporezivi iznos za godišnji porez za 2025. godinu?", a: "5.439.096 RSD — trostruki iznos prosečne godišnje zarade po zaposlenom za 2025. (1.813.032 RSD po podatku RZS). To odgovara proseku od oko 453.000 RSD neto mesečno." },
      { q: "Koje su stope godišnjeg poreza na dohodak?", a: "10% na oporezivi dohodak do 10.878.192 RSD (šest prosečnih godišnjih zarada za 2025), a 15% samo na deo oporezivog dohotka preko tog iznosa." },
      { q: "Da li mlađi od 40 godina plaćaju godišnji porez?", a: "Imaju dodatno umanjenje od 5.439.096 RSD na zbir zarada, prihoda od samostalne delatnosti i autorskih prihoda. Ako žive samo od tih prihoda, obveznici postaju tek preko 10.878.192 RSD neto godišnje (oko 906.000 RSD mesečno)." },
      { q: "Da li dividende i kapitalni dobici ulaze u godišnji porez?", a: "Ne. Dividende, kamate i kapitalni dobici oporezuju se posebnim konačnim porezima i ne sabiraju se u dohodak za godišnji porez na dohodak građana." },
      { q: "Kako i do kada se podnosi prijava PP GPDG?", a: "Isključivo elektronski preko portala ePorezi, najkasnije do 15. maja godine koja sledi godini za koju se porez utvrđuje — do istog datuma se porez i plaća. Poreska uprava od 1. aprila postavlja unapred popunjenu prijavu koju obveznik proverava i podnosi klikom na „Potpiši i podnesi”." },
      { q: "Šta se dešava ako ne podnesem prijavu za godišnji porez?", a: "Poreska uprava podnosi prijavu umesto vas na osnovu službenih podataka, obaveza se uvećava za kamatu, a protiv obveznika se pokreće prekršajni postupak po čl. 180 ZPPPA. Prijavu treba podneti i porez platiti što pre." },
    ],
  },
  {
...
- **Isplata:** ministarstvo nadležno za brigu o porodici, direktno na račun, oko 20. u mesecu.
...
- [Zakon o finansijskoj podršci porodici sa decom](https://www.paragraf.rs/propisi/zakon-o-finansijskoj-podrsci-porodici-sa-decom.html) — čl. 12–20 (naknada zarade, ostale naknade, minimum i maksimum)
- Zakon o radu, čl. 94–100 (porodiljsko odsustvo i odsustvo radi nege deteta)
- RZS — prosečna zarada, april 2026 (saopštenje 170/2026); [pregled prosečnih zarada](/prosecna-zarada)
`,
    faq: [
...
## Prosečna plata po mesecima 2026

Prosečna zarada varira iz meseca u mesec, zavisno od isplata bonusa, broja radnih dana i sezonskih kretanja. Trend je tokom poslednjih meseci jasno uzlazan:

![Kretanje prosečne neto zarade u Srbiji od avgusta 2025. (105.590 din) do marta 2026. (121.650 din).](/media/prosecna-neto-zarada-kretanje-2026.svg)

| Mesec 2026. | Bruto zarada | Neto zarada | Medijalna neto |
|---|---|---|---|
...
|---|---|
| Računarsko programiranje i IT usluge | ~311.370 din (najviša) |
| Finansije i osiguranje | iznad proseka |
| Snabdevanje energijom (struja, gas) | iznad proseka |
| Rudarstvo | ~116.000 din |
| Trgovina | oko proseka / ispod |
| Ugostiteljstvo (hoteli i restorani) | najniža (3× manje od IT-a) |

Najviše zarađuje **informaciono-komunikacioni sektor** — prosečna neto plata u računarskom programiranju premašuje 311.000 din, više od tri puta iznad državnog proseka. Na dnu su ugostiteljstvo, tekstilna industrija i delovi trgovine.

## Prosečna plata po gradovima i regionima
...
|---|---|---|
| Stari grad (Beograd) | 271.497 din | 200.666 din |
| Vračar (Beograd) | 262.492 din | 192.878 din |
| Beogradski region | 198.080 din | 144.028 din |
| Novi Sad (Južnobačka) | 181.542 din | — |
| Šumadija i Zapadna Srbija | — | ~90.705 din (najniža) |

**Beograd ubedljivo prednjači** — prosečna neto plata je oko 144.000 din, a u najbogatijim opštinama (Stari grad, Vračar, Savski venac, Novi Beograd) prelazi 190.000 din neto. Najniže zarade su na jugu zemlje (Jablanička, Pčinjska i Toplička oblast).

## Prosečna plata u evrima

Po srednjem kursu NBS od **117,40 din za 1 €**, ključni iznosi su:
...
Kurs dinara prema evru kreće se u uskom rasponu (oko 117 din/€), pa se iznosi u evrima menjaju malo iz meseca u mesec.

## Rast prosečne plate kroz godine

Prosečna zarada raste već nekoliko godina po stopi iznad 10% godišnje. Prema zvaničnoj obračunskoj prosečnoj godišnjoj zaradi (bruto):

| Godina | Prosečna godišnja zarada (bruto) | Mesečni prosek (bruto) |
|---|---|---|
...
RZS prosečnu zaradu računa na osnovu poreske prijave PPP-PD koju podnose svi poslodavci, pa obuhvata sve formalno zaposlene (ne i rad „na crno" niti paušalce). Mesečni prosek se dobija deljenjem ukupne mase isplaćenih zarada brojem zaposlenih, pa na njega utiču i jednokratne isplate poput [bonusa](/blog/porez-na-bonus), regresa i [toplog obroka](/blog/topli-obrok-i-regres). Obračun konkretne zarade možete proveriti našim [kalkulatorom zarade](/).

## Sačuvajte i podelite
...
- [RZS — Saopštenje o zaradama (januar 2026)](https://www.stat.gov.rs/sr-latn/vesti/statisticalrelease/?p=17829)
- [Prosečna mesečna zarada (Paragraf)](https://www.paragraf.rs/statistika/prosecna_mesecna_zarada_po_zaposlenom_u_republici_srbiji.html)
...
## APR naknade za 2026. godinu

Zvanične naknade Agencije za privredne registre (okvirno, online procedura):

| Stavka | Iznos (RSD) | Napomena |
|---|---|---|
| Registracija preduzetnika (paušal) | ≈ 2.500–2.900 | Najjeftinije osnivanje, online |
| Registracija DOO (online) | ≈ 5.900 | E-registracija preko APR aplikacije |
| Registracija DOO (klasično) | ≈ 6.500 | Podnošenje preko zastupnika |
| Minimalni osnovni kapital DOO | 100 | Simbolično; uplata moguća naknadno |

> **Važno:** prema novoj Odluci od 1.1.2026. pojedini izvori navode i višu jedinstvenu naknadu (do ~8.000 RSD) kada se uz osnivanje registruju i dodatni dokumenti. Tačan iznos za vaš slučaj **proverite na [APR — naknade](https://www.apr.gov.rs/registri/privredna-drustva/naknade.2044.html).**

## Dodatni troškovi (van APR-a)

- **Notarska overa** (kod DOO): okvirno **2.000–5.000 RSD**, zavisno od beležnika.
- **Pečat:** zakonski više nije obavezan, ali ga neke banke traže — izrada ~**2.500–5.000 RSD**.
- **Poslovni račun u banci:** otvaranje je obično besplatno, uz mesečno održavanje ~**500–1.200 RSD**.
- **Knjigovodstvo:** paušalcu nije obavezno; DOO mora da vodi dvojno knjigovodstvo (mesečna usluga knjigovođe).
...
Registracija je jednokratna — veći deo troška su **mesečne obaveze**:

- **Paušalac:** fiksni mesečni porez i doprinosi, okvirno **30.000–45.000 RSD**, zavisno od šifre delatnosti i opštine (tačan iznos određuje rešenje Poreske uprave). Limit prometa za paušal je **6.000.000 RSD** godišnje.
- **DOO:** doprinosi za direktora, knjigovodstvene usluge i bankarske naknade; varira, ali je po pravilu viši od paušala.

## Rok koji se najčešće promaši

U roku od **15 dana od registracije**, firma mora podneti **prvu (akontacionu) poresku prijavu** (PPPDG-1S za DOO, odnosno odgovarajuća prijava za preduzetnika). Kašnjenje povlači **automatske penale** — ovo je najčešća skupa greška novih osnivača.

## Česte greške

- **Računanje samo APR naknade.** Notar, knjigovodstvo i mesečne obaveze čine najveći deo troška.
- **Otvaranje DOO „jer zvuči ozbiljnije".** Za samostalan rad niskog rizika paušal je često jeftiniji — uporedite pre odluke.
- **Propuštanje roka od 15 dana** za prvu poresku prijavu.
- **Mešanje privatnog i poslovnog računa**, što kasnije pravi probleme u knjigovodstvu i kod kontrole.

## Savet

Pre osnivanja, uporedite forme i izračunajte ukupan mesečni trošak, ne samo naknadu za registraciju. Za izbor između samostalnog rada, paušala i firme pogledajte [frilenser, paušalac ili firma](/blog/frilenser-pausalac-firma), a obračun zarade iz radnog odnosa proverite [kalkulatorom zarade](/). Za konkretan slučaj se obratite knjigovođi.
...
- [Zakon o privrednim društvima (Paragraf)](https://www.paragraf.rs/propisi/zakon_o_privrednim_drustvima.html)
    `,
    faq: [
      { q: "Koliko košta otvaranje paušalne radnje u 2026. godini?", a: "APR naknada za registraciju preduzetnika (paušalca) iznosi okvirno 2.500–2.900 RSD za online prijavu. Paušalac nema notarske troškove ni obavezno knjigovodstvo, pa je ukupan start često ispod 10.000 RSD. Tačan iznos naknade proverite na sajtu APR." },
      { q: "Koliko košta osnivanje DOO u Srbiji 2026?", a: "APR naknada za DOO je okvirno 5.900 RSD online, odnosno 6.500 RSD klasičnom procedurom; pojedini izvori navode i višu jedinstvenu naknadu (do ~8.000 RSD) uz registraciju dodatnih dokumenata. Uz notarsku overu i pravnu pomoć, ukupan realan trošak kreće se od 500 do 1.500 EUR." },
      { q: "Koliki je minimalni kapital za DOO?", a: "Minimalni osnovni kapital za DOO je simboličnih 100 RSD, a može se uplatiti i naknadno. Strancima koji apliciraju za privremeni boravak po osnovu firme često se preporučuje viši kapital (oko 250 EUR)." },
...
Kao frilenser plaćate porez i doprinose **sami, kvartalno**, biranjem između dva modela samooporezivanja. Detaljno smo to objasnili u vodiču o [porezu za frilensere (Model A i B)](/blog/porez-za-frilensere).
...
Paušalac je preduzetnik registrovan u **Agenciji za privredne registre (APR)** koji plaća **fiksan mesečni iznos** poreza i doprinosa, bez obzira na to koliko je tog meseca zaradio. Ko ispunjava uslove i kako se obračunava — u vodiču o [paušalnom oporezivanju](/blog/pausalno-oporezivanje).
...
| Obeležje | Frilenser | Paušalac | DOO |
|---|---|---|---|
| Pravni status | Fizičko lice | Preduzetnik | Pravno lice |
| Izdavanje faktura | Ne | Da | Da |
| Fiksni mesečni trošak | Ne (plaća se po prihodu) | Da (~30–45k RSD) | Varijabilno (knjigovođa, doprinosi) |
| Knjigovodstvo | Nije potrebno | Nije obavezno | Obavezno |
| Odgovornost | Lična imovina | Lična imovina | Do visine uloga |
| Limit prometa | — | 6.000.000 RSD/god. | — |
| Najbolje za | Povremene i inostrane prihode | Stabilan samostalni rad | Partnere, rast, B2B |
...
Izbor zavisi od visine i stabilnosti prihoda, potrebe za fakturama i tolerancije na rizik. Za povremene, jednokratne poslove pogledajte i [ugovor o delu](/blog/ugovor-o-delu), a za pun pregled doprinosa vodič o [doprinosima u Srbiji](/blog/doprinosi-srbija). Pre same odluke o prelasku, proverite konkretne iznose sa knjigovođom.
...
Da biste poslovali kao paušalac, potrebno je da ispunite nekoliko uslova:

- Da ste registrovani kao **preduzetnik** (kod Agencije za privredne registre — APR).
- Da vam godišnji promet **ne prelazi 6.000.000 dinara**.
- Da se bavite **delatnošću koja je dozvoljena** za paušalno oporezivanje.

Ako ispunjavate uslove, prilikom registracije birate paušalno oporezivanje, a Poreska uprava vam **rešenjem** utvrđuje mesečni iznos obaveza.

## Koje delatnosti ne mogu u paušal

Zakon o porezu na dohodak građana isključuje pojedine delatnosti iz paušalnog režima. Paušalno oporezivanje, po pravilu, **nije dozvoljeno** za sledeće delatnosti:

- **trgovina** na veliko i malo,
- **ugostiteljstvo** (priprema i posluživanje hrane i pića),
- **finansijsko posredovanje i osiguranje**,
- delatnosti iz oblasti **reklamiranja i istraživanja tržišta** (član 40. Zakona).

Većina uslužnih i IT delatnosti, sa druge strane, **može** da posluje paušalno.

## Dva limita: 6 miliona i 8 miliona dinara

Lako je pomešati dva različita limita, pa ih razdvajamo:

- **6.000.000 dinara — limit za paušal.** Odnosi se na promet u jednoj kalendarskoj godini (prema izdatim fakturama, odnosno KPO knjizi). Ako ga pređete, gubite pravo na paušal i prelazite na vođenje poslovnih knjiga.
- **8.000.000 dinara — limit za PDV.** Odnosi se na sve privredne subjekte i posmatra se u kontinuitetu, za bilo kojih 365 uzastopnih dana. Kada ga pređete, obavezni ste da uđete u sistem PDV-a.

## Kako se određuje paušalni porez i doprinosi

Mesečnu obavezu utvrđuje Poreska uprava na osnovu **polazne osnovice** (paušalnog prihoda), koja zavisi od više faktora:

- **šifre delatnosti** i pripadajućeg koeficijenta,
- **opštine** u kojoj je sedište,
- **prosečne zarade** u toj sredini.
...
## Paušal ili samooporezivanje (frilenseri)?

Mnogi koji rade za inostrane klijente biraju između dve opcije:

- **Samooporezivanje** kao fizičko lice — frilenser (videti naš vodič o [porezu za frilensere](/blog/porez-za-frilensere)).
- **Paušalno oporezivanje** kao preduzetnik.

Okvirno pravilo:

- Za **niže i povremene prihode** često je jednostavnije ostati na **samooporezivanju**.
- Za **redovne i veće prihode** (bliže limitu od 6 miliona) **paušal** po pravilu daje nižu ukupnu obavezu, ali nosi obaveze preduzetnika (registracija, mesečna plaćanja, eventualno knjigovođa).

Pošto prelomna tačka zavisi od konkretnih iznosa, najbolje je uporediti obe opcije pre odluke.

## Registracija i obaveze paušalca

- Registracija se obavlja kod **APR-a** (Agencija za privredne registre).
- Paušalac vodi samo **KPO knjigu** (knjiga o ostvarenom prometu).
- Mesečno plaća porez i doprinose prema rešenju, u propisanim rokovima.

## Šta kada se pređe limit
...
U poreskom smislu, frilenser je fizičko lice koje ostvaruje prihod od **ugovorene naknade za rad** (najčešće od klijenata iz inostranstva), a koji nije oporezovan po drugom osnovu u trenutku isplate. Tu spadaju, na primer, prihodi od programiranja, dizajna, prevođenja, pisanja, marketinga i sličnih usluga koje fizičko lice pruža samostalno.

Na ove prihode primenjuje se **Zakon o porezu na dohodak građana**, a obračun i prijava se rade preko portala **frilenseri.purs.gov.rs**.

## Dva modela samooporezivanja

Frilenseri biraju jedan od dva modela, i to **za svaki kvartal posebno** — u jednom tromesečju mogu koristiti jedan model, a u sledećem drugi, u zavisnosti od visine prihoda.

Oba modela koriste **normirane troškove** — iznos koji se oduzima od bruto prihoda pre obračuna poreza i doprinosa. Razlika je u visini tih troškova i u poreskoj stopi.

### Model A (prvi model)

- **Normirani troškovi:** 110.647 dinara po kvartalu (fiksni iznos za 2026. godinu).
- **Poreska stopa:** 20% na osnovicu (bruto prihod umanjen za normirane troškove).
- **Doprinosi:** PIO 24% i zdravstveno osiguranje 10,3% na istu osnovicu.

Zbog visokog fiksnog odbitka, Model A je povoljniji za **niže i neredovne prihode**. Ako u kvartalu zaradite manje od 110.647 dinara, nema poreske osnovice, pa ne plaćate porez (ali mogu postojati minimalni doprinosi — videti niže).

### Model B (drugi model)

- **Normirani troškovi:** 66.733 dinara po kvartalu **i dodatnih 34% bruto prihoda** ostvarenog u kvartalu.
- **Poreska stopa:** 10% na osnovicu.
- **Doprinosi:** PIO 24% i zdravstveno osiguranje 10,3% na osnovicu.

Model B ima nižu poresku stopu (10% umesto 20%) i dodatni procentualni odbitak, pa je po pravilu povoljniji za **veće i stabilnije prihode**.

## Doprinosi: PIO i zdravstveno osiguranje

Pored poreza, frilenseri plaćaju i doprinose za obavezno socijalno osiguranje:

- **PIO (penzijsko i invalidsko osiguranje): 24%**
- **Zdravstveno osiguranje: 10,3%**

Dve važne napomene:

1. **Ako ste već osigurani po drugom osnovu** (na primer, zaposleni ste kod poslodavca koji za vas plaća doprinose), ne plaćate ponovo doprinos za zdravstveno osiguranje kao frilenser.
2. **Postoji najniža osnovica doprinosa.** I kada je prihod nizak, doprinosi se obračunavaju najmanje na propisanu minimalnu osnovicu, pa ukupna obaveza ne može pasti ispod tog minimuma. Tačan iznos prikazuje kalkulator na portalu Poreske uprave.

## Koji model izabrati?

Pravilo je jednostavno:

- **Niži ili neredovan prihod → Model A.** Visok fiksni odbitak (110.647 dinara po kvartalu) često svodi porez na nulu.
- **Viši i redovan prihod → Model B.** Niža poreska stopa od 10% i procentualni odbitak smanjuju ukupnu obavezu.

Najbolja praksa je da **za svaki kvartal proverite oba modela** u kalkulatoru pre podnošenja prijave, jer prelomna tačka zavisi od visine prihoda.

## Primer obračuna (kvartalni prihod 200.000 dinara)

Pretpostavimo da je frilenser u jednom kvartalu ostvario **200.000 dinara** bruto prihoda.

| Stavka | Model A | Model B |
|---|---|---|
| Bruto prihod | 200.000 | 200.000 |
| Normirani troškovi | 110.647 | 134.733 (66.733 + 34%) |
| Poreska osnovica | 89.353 | 65.267 |
| Porez | 17.871 (20%) | 6.527 (10%) |
| Doprinosi (PIO 24% + zdravstvo 10,3%) | ≈ 30.648 | ≈ 22.387 |
| **Ukupna obaveza (okvirno)** | **≈ 48.519** | **≈ 28.914** |

U ovom primeru **Model B je znatno povoljniji**. Iznosi doprinosa su okvirni (bez primene minimalne osnovice); tačan iznos uvek proverite u zvaničnom kalkulatoru.

## Rokovi za prijavu i plaćanje

Poreska prijava (obrazac **PP OPO**) podnosi se **kvartalno**, elektronski, preko portala frilenseri.purs.gov.rs:

| Kvartal | Period | Rok za prijavu |
|---|---|---|
| I kvartal | januar–mart | 30. april |
| II kvartal | april–jun | 30. jul |
| III kvartal | jul–septembar | 30. oktobar |
| IV kvartal | oktobar–decembar | 30. januar |

Porez i doprinosi plaćaju se u istom roku u kojem se podnosi prijava.

## Česte greške

- **Nepodnošenje prijave kada nema poreza.** I kada porez ispadne nula (Model A, nizak prihod), prijavu i dalje treba podneti.
- **Biranje modela bez provere.** Model se bira po kvartalu; uvek uporedite oba pre prijave.
- **Zaboravljanje doprinosa.** Porez je samo deo obaveze — doprinosi za PIO i zdravstvo često su veći od samog poreza.
...
- [Zakon o porezu na dohodak građana](https://www.paragraf.rs/propisi/zakon-o-porezu-na-dohodak-gradjana.html)
    `,
    faq: [
      { q: "Koliko frilenseri plaćaju porez u Srbiji 2026. godine?", a: "Frilenseri plaćaju porez po stopi od 20% (Model A) ili 10% (Model B) na osnovicu koju čini bruto prihod umanjen za normirane troškove, uz doprinose za PIO (24%) i zdravstveno osiguranje (10,3%). Koji je model povoljniji zavisi od visine kvartalnog prihoda." },
      { q: "Koliki su normirani troškovi za frilensere u 2026. godini?", a: "U 2026. godini normirani troškovi po kvartalu iznose 110.647 dinara za Model A, odnosno 66.733 dinara i dodatnih 34% bruto prihoda za Model B." },
      { q: "Do kada se podnosi poreska prijava za frilensere?", a: "Prijava se podnosi kvartalno: za prvi kvartal do 30. aprila, za drugi do 30. jula, za treći do 30. oktobra i za četvrti kvartal do 30. januara naredne godine. Porez i doprinosi plaćaju se u istom roku." },
      { q: "Da li frilenser plaća zdravstveno osiguranje ako je već zaposlen?", a: "Ne. Ako je frilenser već osiguran po osnovu radnog odnosa, ne plaća ponovo doprinos za zdravstveno osiguranje, ali i dalje plaća porez i doprinos za PIO na prihod ostvaren kao frilenser." },
    ],
  },
  {
