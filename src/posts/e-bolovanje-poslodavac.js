// Body + FAQ for "e-bolovanje-poslodavac". Split out of posts.js so a reader
// downloads only the article they open — see loadPostBody() in Blog.jsx.
//
// Intent je PROCES, ne obračun. Iznos naknade (65% / 100%), formula i osnovica
// namerno ostaju na /bolovanje i /blog/kako-se-obracunava-bolovanje — ovde se
// samo linkuju, da se dve strane ne kanibalizuju.

export const body = `
![e-Bolovanje za poslodavce — registracija na Portalu eUprava i rokovi za zahteve RFZO-u](/media/blog/e-bolovanje-poslodavac.png)
...
| Datum | Šta se dešava | Koga se tiče | Osnov |
|---|---|---|---|
| 12. decembar 2025 | Zakon stupio na snagu | svi | čl. 15 Zakona 109/2025 |
| **1. januar 2026** | Početak primene; krajnji rok za registraciju; prestaje primena čl. 103 Zakona o radu (papirna doznaka) | pravna lica, organi, ustanove, beležnici, izvršitelji | čl. 3, 13, 14 i 15 |
| **1. april 2026** | Kroz sistem se elektronski podnose zahtevi za obračun naknade zarade, prigovori, zahtevi za preispitivanje i veštačenje | isti poslodavci | čl. 15 Zakona 109/2025 |
| **8. avgust 2026** | Na snazi novi Pravilnik (71/2026); Pravilnik 121/2025 stavljen van snage | svi korisnici sistema | Pravilnik 71/2026 |
| **1. januar 2027** | Krajnji rok za **registraciju u sistem** — i samo za nju; prestanak obaveze doznake važio je i za zaposlene kod preduzetnika od 1. januara 2026 | preduzetnici sa zaposlenima | čl. 13 i čl. 14 Zakona 109/2025 |
...
**Koliko iznosi naknada — videti [kalkulator bolovanja](/bolovanje) i vodič [kako se obračunava bolovanje](/blog/kako-se-obracunava-bolovanje); ovde nas zanima samo šta poslodavac podnosi i do kada.**
...
| # | Radnja | Ko je vrši | Rok | Osnov |
|---|---|---|---|---|
| 1 | Isplata zarade i naknade za mesec u kome je bilo bolovanje | poslodavac | po ugovorenom danu isplate | čl. 102 ZZO |
| 2 | Podnošenje zahteva za isplatu naknade zarade **sa svim dokazima** matičnoj filijali (od 1. aprila 2026. kroz sistem) | poslodavac | **najkasnije 15 dana** od dana isplate zarade za mesec na koji se naknada odnosi | uputstvo RFZO-a — čl. 102 ZZO ne propisuje broj dana |
| 3 | Utvrđivanje prava, obračun naknade i **obezbeđivanje sredstava** prenosom na poseban račun poslodavca | matična filijala RFZO | **najkasnije 21 dan** od prijema potpunog zahteva | čl. 102 st. 3 ZZO |
| 4 | Isplata naknade zaposlenom — **isplatilac je poslodavac, nikada RFZO** | poslodavac | **najkasnije 7 dana** od prijema sredstava | čl. 102 st. 4 ZZO |
| 5 | Vraćanje sredstava filijali **sa kamatom**, ako isplata izostane | poslodavac | po isteku roka od 7 dana | čl. 102 st. 4 ZZO |
...
| Poslodavac vidi | Poslodavac ne dobija automatski |
|---|---|
| ime i prezime zaposlenog | opis bolesti i medicinsku dokumentaciju |
...
| Prekršaj | Ko odgovara | Kazna | Osnov |
|---|---|---|---|
| Ne koristi softversko rešenje, ne registruje se ili ne obavlja radnje kroz sistem | pravno lice — **osim** Republike Srbije, teritorijalnih autonomija i jedinica lokalne samouprave i njihovih organa | **50.000–200.000 RSD** | čl. 10 st. 1 Zakona 109/2025 |
| isto | preduzetnik sa zaposlenima | **10.000–50.000 RSD** | čl. 10 Zakona 109/2025 |
| isto | odgovorno lice u pravnom licu | **5.000–25.000 RSD** | čl. 10 Zakona 109/2025 |
| Ne podnese zahtev sa dokazima, ne isplati zaposlenom u roku od 7 dana ili ne vrati sredstva sa kamatom | poslodavac | **300.000–1.000.000 RSD** | čl. 260 ZZO |
