...
| Slučaj | Ko obezbeđuje sredstva | Visina naknade |
|---|---|---|
| Prvih 30 dana (opšte pravilo) | **Poslodavac**, iz svojih sredstava | najmanje 65% prosečne zarade |
| Od 31. dana (opšte pravilo) | **RFZO** (Republički fond za zdravstveno osiguranje) | isti procenat kao i prvih 30 dana |
| Povreda na radu i profesionalna bolest | **Poslodavac**, iz svojih sredstava, od prvog dana i za sve vreme trajanja | 100% |
| Dobrovoljno davanje organa, ćelija i tkiva; nega obolelog deteta mlađeg od tri godine; izolacija kao kliconoša ili zbog pojave zaraznih bolesti u okolini | **RFZO**, od prvog dana | prema osnovu sprečenosti |
...
| Faza | Rok |
|---|---|
| Poslodavac podnosi filijali RFZO zahtev sa dokazima | **15 dana** od isplate zarade za mesec na koji se naknada odnosi |
| Filijala vrši obračun i prenosi sredstva poslodavcu | **21 dan** od prijema potpunog zahteva |
| Poslodavac isplaćuje zaposlenom | **7 dana** od prijema sredstava |
...
Ceo postupak koji poslodavac od 2026. sprovodi kroz sistem e-Bolovanje — registracija pravnog lica, dodela uloga, rokovi i kazne — opisan je u vodiču [e-bolovanje za poslodavce](/blog/e-bolovanje-poslodavac).
...
| Slučaj | Ko obezbeđuje sredstva | Ko isplaćuje zaposlenom | Kada zaposleni dobija novac |
|---|---|---|---|
| Bolovanje do 30 dana | Poslodavac, iz svojih sredstava | **Poslodavac** | uz redovnu isplatu zarade |
| Bolovanje preko 30 dana | RFZO, prenosom sredstava poslodavcu | **Poslodavac** | u roku od 7 dana od prijema sredstava od filijale |
| Povreda na radu i profesionalna bolest | Poslodavac, iz svojih sredstava, za sve vreme trajanja | **Poslodavac** | uz redovnu isplatu zarade |
...
- [Zakon o radu — čl. 77, 103 i 115 (Paragraf.rs)](https://www.paragraf.rs/propisi/zakon_o_radu.html)
- [Zakon o zdravstvenom osiguranju — čl. 95, 101, 102, 143 i 148 (Paragraf.rs)](https://www.paragraf.rs/propisi/zakon_o_zdravstvenom_osiguranju.html)
- [Zakon o razmeni podataka … „e-Bolovanje – Poslodavac" — tekst predloga, čl. 9, 13, 14 i 15 (Narodna skupština)](https://www.parlament.gov.rs/upload/archive/files/lat/pdf/predlozi_zakona/14_saziv/2221-25%20-%20Lat..pdf)
- [Predlog zakona o izmenama i dopunama Zakona o zdravstvenom osiguranju — tekst čl. 102, 143 i 148 (Narodna skupština)](https://www.parlament.gov.rs/upload/archive/files/lat/pdf/predlozi_zakona/13_saziv/1933-23%20-%20Lat..pdf)
- [Zakon o doprinosima za obavezno socijalno osiguranje (Paragraf.rs)](https://www.paragraf.rs/propisi/zakon-o-doprinosima-za-obavezno-socijalno-osiguranje.html)
- [Republički fond za zdravstveno osiguranje](https://www.rfzo.rs/)
`;
